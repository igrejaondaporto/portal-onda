  ...
  financeiro: {
    passos: [
      ...
      },
      {
        chave: "nav-entradas",
        titulo: "Entradas",
        texto: "Dízimos, ofertas e outras receitas. Regista aqui, e cria uma fonte fixa para o que se repete todo mês.",
        alvo: "nav-entradas", pagina: "entradas",
      },
      {
        ...
        alvo: "nav-fornecedores", pagina: "fornecedores",
      },
      {
        chave: "nav-caixa",
        titulo: "Caixa",
        texto: "O extrato: saldo, totais por base e por mês, e a exportação para a contabilidade.",
        alvo: "nav-caixa", pagina: "caixa",
      },
      {
        chave: "fechamento",
