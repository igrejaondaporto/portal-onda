/**
 * Ícones, favicon e og-image da Base Comunicação — mesmo gradiente
 ...
 *
 *     node scripts/gerar-assets-comunicacao.mjs
 */
import sharp from "sharp";
import { writeFileSync } from "node:fs";
import { fileURLToPath } from "node:url";

const DIR = new URL("../apps/comunicacao/public/", import.meta.url);
...
const svgIconeFinal = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  ...
  <text x="50%" y="55%" text-anchor="middle" dominant-baseline="middle"
    font-family="Outfit, Arial, sans-serif" font-weight="800" font-size="200"
    fill="#ffffff">CM</text>
</svg>`;
...
const svgOg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <g font-family="Outfit, Arial, sans-serif" text-anchor="middle">
    ...
    <text x="600" y="405" font-weight="800" font-size="26" letter-spacing="6" fill="#c3dc54">COMUNICAÇÃO</text>
  </g>
...
console.log("Assets da Comunicação gerados em apps/comunicacao/public/");
