/**
 * Ícones, favicon e og-image da Base Pessoal — mesmo gradiente
 ...
 *
 *     node scripts/gerar-assets-pessoal.mjs
 */
import sharp from "sharp";
import { writeFileSync } from "node:fs";
import { fileURLToPath } from "node:url";

const DIR = new URL("../apps/pessoal/public/", import.meta.url);
...
const svgOg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <g font-family="Outfit, Arial, sans-serif" text-anchor="middle">
    ...
    <text x="600" y="405" font-weight="800" font-size="26" letter-spacing="6" fill="#c3dc54">PESSOAL</text>
  </g>
...
console.log("Assets da Base Pessoal gerados em apps/pessoal/public/");
