...
| Técnica | Melhorias — tracker de avarias/sugestões com linha do tempo, gravidade, meta/previsão e "Transformar em artigo da Wiki" (`bases/{b}/melhorias`, 6 Cloud Functions) | Não depende de ministérios nem de equipamentos — `equipamentoId`/`ministerioId` são opcionais no modelo. Qualquer base futura (com ou sem equipamentos, com ou sem ministérios) pode reaproveitar tal e qual. |
