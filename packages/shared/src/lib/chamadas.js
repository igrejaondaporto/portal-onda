 ...
 * FreeShow da igreja — não mudar sem confirmar com quem mexe lá. O
 * "Kinder" (id "kinder") é o mesmo canal que antes se chamava
 * "Júnior" só no rótulo — por baixo continua a mexer na mesma
 * variável/overlay de sempre.
 */
export const CANAIS_CHAMADAS = [
  ...
  { id: "kinder", oid: "b239c603705", rotulo: "Kinder", overlay: "Z_JUNIOR", variavel: "junior", prefixo: "KINDER: ", campo: "Nome da criança", exemplo: "Arthur", maiusculas: false, cor: "var(--verde)" },
