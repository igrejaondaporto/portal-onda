 ...
 *
 *  `pessoaAlvo` ({id, nome}) é só do líder/auxiliar: corrigir o voto
 *  de quem votou errado, ou votar por quem ainda não respondeu — ver
 *  PainelLider.jsx. Sem isto, é sempre a própria pessoa a responder.
 *
  ...
  return (
    <>
      ...
      <div className="pin on" role="dialog" aria-modal="true">
        ...
        <label className="rot" style={{ marginTop: 14 }}>Justificativa (opcional)</label>
