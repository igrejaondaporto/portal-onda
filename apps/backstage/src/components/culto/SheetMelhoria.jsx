...
import {
  ...
  definirPrevisao, resolverMelhoria, desativarMelhoria,
...
export default function SheetMelhoria({ melhoriaId, uid, papel, voluntarios, editarInicial = false, resolverInicial = false, onFechar, onGuardado }) {
  ...
  return (
    <>
      ...
      <div className="pin on" role="dialog" aria-modal="true">
        ...
        {melhoria.estado === "resolvida" && souLiderBase && (
          <button className="btn sec full" style={{ marginTop: 16 }} onClick={reabrir}>Reabrir</button>
        )}
