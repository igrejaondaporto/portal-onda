...
function useCultosDoMes(mes) {
  ...
  async function adicionarEspecial() {
    ...
    try {
      // atalho dentro da enquete: cria sempre global — a Backstage é a
      // única base com essa capacidade; para um culto só desta base,
      // usar "Cultos e eventos" no Painel do Líder (pede o escopo).
      await criarCultoEspecial({ data, tipo: nome, escopo: "global", horaCulto: "10:30", horaChegada: "08:00" });
