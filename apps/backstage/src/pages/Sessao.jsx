...
import { concordar, hojeISO } from "@portal/shared/lib/data.js";
...
export default function Sessao({ uid, papel, baseId, veTodasEscalas, podePublicarCulto, feedbackAberto, mostrarTourAoEntrar }) {
  ...
  // ponto rosa no menu: o culto de hoje, gravado pela Técnica — só
  // leitura aqui, quem inicia é sempre a Técnica
    ...
    <TourProvider>
      ...
      <div className="app">
        ...
        <div className="corpo">
          ...
          {pagina === "enquetes" && lider && (
            <Enquetes ativo={pagina === "enquetes"} definirCabecalho={setCab} />
          )}
          {pagina === "perfil" && (
            <Perfil
