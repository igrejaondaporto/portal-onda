...
import { ouvirRepertorioLouvorKinder } from "../../lib/repertorioLouvorKinder";

const LINKS = [["video", "Vídeo"], ["letra", "Letra"], ["audio", "Áudio"]];

/** O repertório que o líder do Louvor Kinder escolheu para o culto,
 *  dentro do bloco da Lição no Início — o mesmo para as três salas.
