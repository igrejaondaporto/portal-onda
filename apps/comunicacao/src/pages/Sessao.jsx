      ...
      <div className="app">
        ...
        <div className="corpo">
          ...
          <div style={{ display: pagina === "solicitacoes" ? "" : "none" }}>
            <Solicitacoes uid={uid} papel={papelEfetivo} ativo={pagina === "solicitacoes"} definirCabecalho={setCab} />
          </div>
          <div style={{ display: pagina === "brand" ? "" : "none" }}>
            <Brand papel={papelEfetivo} ativo={pagina === "brand"} definirCabecalho={setCab} />
          </div>
          <div style={{ display: pagina === "culto" ? "" : "none" }}>
            <Culto
              uid={uid} papel={papelEfetivo} mes={mes} ano={ano} mudarMes={mudarMes} abaAlvo={abaCulto}
