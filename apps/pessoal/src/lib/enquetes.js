 ...
 *
 * Cópia 1:1 do que já existe na Técnica/Backstage — mesmo path, mesmo
 * schema, mesmas Cloud Functions (já genéricas por baseId, nunca
 * precisaram de mudar para isto funcionar aqui também).
 */
