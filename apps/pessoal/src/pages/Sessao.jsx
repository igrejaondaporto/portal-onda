...
export default function Sessao({ uid, papel, baseId, podePublicarCulto, mostrarTourAoEntrar }) {
  ...
  const ABAS = lider ? [...ABAS_BASE, ["montar", "Enquetes", ICONE_MONTAR]] : ABAS_BASE;
      ...
      <div className="app">
        ...
        <div className="corpo">
          ...
          <div style={{ display: pagina === "formulario" ? "" : "none" }}>
            <Formulario uid={uid} papel={papelEfetivo} ativo={pagina === "formulario"} definirCabecalho={setCab} />
          </div>
          <div style={{ display: pagina === "acomodacao" ? "" : "none" }}>
            <Acomodacao uid={uid} papel={papelEfetivo} ativo={pagina === "acomodacao"} definirCabecalho={setCab} />
          </div>
          {pagina === "reembolsos" && (
