 ...
 * ninguém marcou; depois de marcado, só o líder corrige (o servidor
      ...
      {valor == null ? (
        <div className="destaque" onClick={abrir}>
          <div>
            ...
            <p style={{ fontSize: 17, fontWeight: 700, marginTop: 5, letterSpacing: "-.03em" }}>Quantas crianças {estao} presentes?</p>
        ...
        <div className="linha" style={{ cursor: soLeitura ? "default" : "pointer" }} onClick={abrir} role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") abrir(); }}>
          <div style={{ flex: 1 }}>
            ...
            <p className="ds">{quando} · {soLeitura ? "só o líder pode corrigir" : "toca para corrigir"}</p>
          </div>
