/**
 * Quantos jovens estão presentes — pedido 2026-09 ("quero o mesmo no
 * painel do SHIFT e do New"), mesmo mecanismo da Kinder (ver
 * `apps/kinder/src/lib/contagemCriancas.js`): escreve em
 * `eventos/{e}/contagem/geral` (a Contagem da Base Pessoal) pela
 * Cloud Function `registarContagemSala` — nunca escrita direta, esta
 * base só pode tocar na sua própria categoria ("new") dentro do mapa
 * `categorias`.
 *
