 ...
 *
 * O link de referência da versão tem botão próprio ao lado do selo de
 * tom (ver SheetEditarLink.jsx) — não vive mais aqui dentro
 * (2026-09, pedido do líder: "desmembra isso de Tom").
 */
